...
const ru: LANG_MESSAGE = {
  ...
  mitmCapture: 'Захват тела MITM',
  mitmCaptureTip:
    'Заголовки запросов и ответов записываются всегда. Включение также сохраняет полные тела и может увеличить нагрузку на память и процессор. Изменяется только состояние во время выполнения; следующая загрузка конфигурации восстановит заданное в ней значение.',
  requestHeaders: 'Заголовки запроса',
  responseHeaders: 'Заголовки ответа',
  body: 'Тело',
  enableCaptureToGetContent: 'Включите захват, чтобы получить содержимое',
  geoInfo: 'GeoIP',
  dl: 'Загр',
  ul: 'Отдч',
  dlSpeed: 'Загрузка',
