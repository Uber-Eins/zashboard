...
export type LogTransactionStatusFilter = '' | 'active' | 'modified' | 'failed'
...
export const logTransactionStatusFilter = ref<LogTransactionStatusFilter>('')
export const logTransactionStatusAvailable = ref(false)
